...
class ExportConfigTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $scopeConfig->method('getValue')->willReturnMap([
            ['factfinder_export/data_transfer/ff_export_push_import_type', Scope::SCOPE_STORES, 1, 'search,suggest'],
            ['factfinder_export/export/attributes', Scope::SCOPE_STORES, 42,'{"_1":{"code":"color","multi":"0","numerical":"0"},"_2":{"code":"climate","multi":"1","numerical":"0"},"_3":{"code":"gender","multi":"0","numerical":"0"},"_4":{"code":"size","multi":"1","numerical":"1"}}']
        ]);
