...
use Factfinder\Export\Model\Filesystem\Io\UploadFactory;
...
class FtpUploader
{
    ...
    public function __construct(private readonly FtpConfig $config, private readonly UploadFactory $uploadFactory)
    {
    }
    ...
    public function testConnection(array $params): void
    {
        ...
        try {
            ...
            $this->writeFile($fileName); // Check write permission
